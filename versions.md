...
### Версия 1.10.0 - 15.09.2025
- **versionCode**: 36
- **versionName**: "1.10.0"
- **Изменения**:
  - Добавлено уведомление об успешном сохранении заметки (Toast)
  - Реализован автозапуск обработки при вставке ссылки из буфера обмена
  - Добавлен автозапуск обработки при получении ссылки через меню "Поделиться"
  - В конце заметки автоматически добавляется отметка времени сохранения в формате "Сохранено: ДД.ММ.ГГГГ ЧЧ:ММ"

### Версия 1.9.7 - 14.09.2025
- **versionCode**: 35
- **versionName**: "1.9.7"
- **Изменения**:
  - Косметические доработки интерфейса настроек

### Версия 1.9.6 - 14.09.2025
- **versionCode**: 34
- **versionName**: "1.9.6"
- **Изменения**:
  - Добавлен паттерн для сайта doka.guide
  - Исправлен баг с сохранением заметок без изображений при опции "Всегда спрашивать" папку
